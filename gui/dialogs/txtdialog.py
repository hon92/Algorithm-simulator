...
class TXTDialog():
    TITLE_OPEN = "Open txt file"
    TITLE_WRITE = "Save txt file"

    @staticmethod
    def open_file():
        dialog = gtk.FileChooserDialog(TXTDialog.TITLE_OPEN,
                                       None,
        ...
        xml_file_filter.set_name("Txt files")
        xml_file_filter.add_pattern("*.txt")
    ...
    def save_file(filename):
        dialog = gtk.FileChooserDialog(TXTDialog.TITLE_WRITE,
                                       None,
